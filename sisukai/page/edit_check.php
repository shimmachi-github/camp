<?php
    ...
    //POSTをエスケープ処理
    $post = sanitize($_SESSION['editpost']);
    ...
    if(!empty($_POST['check'])){
        ...
        //入力情報をデータベースに更新
        $statement = $db->prepare("UPDATE oi31_users SET name=?, email=?, password=? WHERE id=?");
        ...
        header('Location: edit_done.php'); //edit_done.phpへ移動
        exit();
    }
    ...
    <div class="container">
        ...
        <div id="">
            ...
            <form action="" method="POST">
                ...
                <br>
                <a href="regist.php" class="back-btn">入力内容を変更する</a>
                <button type="submit" class="btn next-btn">更新する</button>
                <div class="clear"></div>
            </form>
        </div>
        </div>
